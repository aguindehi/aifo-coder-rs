...
#![doc = "- Map io::ErrorKind::NotFound to exit code 127; all others to 1."]
#![doc = "- Prefer ForkError/ToolchainError for internal clarity while preserving user-visible strings via display_* helpers."]
#![doc = "- Keep mapping/styling consistent with v1; no behavior changes."]
use std::io;
