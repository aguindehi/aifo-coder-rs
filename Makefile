...
HOOK_SCRIPT_PRE_PUSH := scripts/git-pre-push
HOOK_SCRIPT_PRE_COMMIT := scripts/git-pre-commit
PRE_PUSH_HOOK := .git/hooks/pre-push
PRE_COMMIT_HOOK := .git/hooks/pre-commit

ifeq ($(wildcard .git),.git)
  _HOOK_SETUP := $(shell if [ -d .git/hooks ]; then \
    if [ ! -e $(PRE_PUSH_HOOK) ]; then ln -s ../../$(HOOK_SCRIPT_PRE_PUSH) $(PRE_PUSH_HOOK); fi; \
    if [ ! -e $(PRE_COMMIT_HOOK) ]; then ln -s ../../$(HOOK_SCRIPT_PRE_COMMIT) $(PRE_COMMIT_HOOK); fi; \
  fi)
endif
...
help: banner
	...
	$(call title_ul,Docs:)
	@echo ""
	@echo "  docs/INSTALL.md ........................ Install instructions and prerequisites"
	@echo "  docs/README-buildkit.md ................. BuildKit/Kaniko guardrails and CI notes"
	@echo "  docs/README-coding-agent-security-anaysis.md ... Security analysis for coding agents"
	@echo "  docs/README-contributing.md ............. Toolchain overrides, cache layout, env notes"
	@echo "  docs/README-macos-cross-prereqs.md ...... macOS cross-build prerequisites in CI"
	@echo "  docs/README-macos-cross-validation.md ... Validation steps for macOS cross builds"
	@echo "  docs/README-opentelemetry.md ............ OpenTelemetry enablement and testing"
	@echo "  docs/README-security-architecture.md .... Security architecture for aifo-coder"
	@echo "  docs/README-support.md .................. Support matrix across coder/toolchain pairs"
	@echo "  docs/README-testing.md .................. Test lanes, toggles, and how to run"
	@echo "  docs/README-toolchains.md ............... Toolchain sidecars, proxy usage, caches"
	@echo "  docs/README-toolexec.md ................. Shim ↔ proxy HTTP protocol (ToolExec)"
	@echo ""
	$(call title_ul,Tip:)
	@echo ""
