...
#[test]
fn unit_test_registry_probe_curl_success_forced() {
...
#[test]
fn unit_test_registry_probe_curl_failure_forced() {
    let _g = REG_GUARD.lock().unwrap();
    clear_env_overrides();
...
#[test]
fn unit_test_registry_probe_tcp_success_forced() {
    let _g = REG_GUARD.lock().unwrap();
    clear_env_overrides();
...
#[test]
fn unit_test_registry_probe_tcp_failure_forced() {
    let _g = REG_GUARD.lock().unwrap();
    clear_env_overrides();
