...
#[test]
fn test_fork_list_json_stale_flag() {
...
#[test]
fn test_fork_list_all_repos_json_and_env_requirement() {
    if !have_git() {
        eprintln!("skipping: git not found in PATH");
        return;
    }
...
#[test]
fn test_fork_list_json_empty_when_no_sessions() {
    if !have_git() {
        eprintln!("skipping: git not found in PATH");
        return;
    }
...
#[test]
fn test_fork_clean_json_plan_and_exec() {
    if !have_git() {
        eprintln!("skipping: git not found in PATH");
        return;
    }
...
#[test]
fn test_fork_clean_base_unknown_is_protected() {
    if !have_git() {
        eprintln!("skipping: git not found in PATH");
        return;
    }
