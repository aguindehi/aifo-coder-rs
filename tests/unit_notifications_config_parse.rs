...
#[test]
fn unit_test_notifications_config_parse_inline_array() {
...
#[test]
fn unit_test_notifications_config_parse_yaml_list() {
    let _g = NOTIF_CFG_ENV_GUARD.lock().unwrap();
    with_home(|home| {
...
#[test]
fn unit_test_notifications_config_parse_block_scalar() {
    let _g = NOTIF_CFG_ENV_GUARD.lock().unwrap();
    with_home(|home| {
