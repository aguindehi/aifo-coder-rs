...
#[test]
fn unit_test_rust_image_selection_default_and_official() {
    // Preserve old env
    ...
    assert_eq!(
        img_default, "aifo-coder-toolchain-rust:1.80",
    ...
    assert_eq!(
        img_official, "aifo-coder-toolchain-rust:1.80",
...
#[test]
fn unit_test_exec_preview_includes_bootstrap_marker_when_set_for_rust_only() {
