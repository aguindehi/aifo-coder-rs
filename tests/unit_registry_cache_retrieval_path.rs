#[test]
fn unit_test_registry_cache_retrieval_path_in_non_quiet_variant() {
    ...
    let first = aifo_coder::preferred_internal_registry_prefix_quiet();
    ...
    remove_var("AIFO_CODER_TEST_REGISTRY_PROBE");
    let second = aifo_coder::preferred_internal_registry_prefix_quiet();
    assert_eq!(
        second, "gamma/",
