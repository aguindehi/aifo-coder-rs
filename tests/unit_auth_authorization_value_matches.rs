...
#[test]
fn unit_test_bearer_scheme_case_insensitive_and_exact_token() {
    let tok = "abc123";
...
#[test]
fn unit_test_whitespace_tolerance_common_patterns() {
    let tok = "t0k3n";
...
#[test]
fn unit_test_wrong_token_and_wrong_scheme() {
    let tok = "needle";
...
#[test]
fn unit_test_punctuation_is_exact_match() {
