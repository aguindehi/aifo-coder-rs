...
#[test]
fn int_test_git_stdout_str_invalid_subcommand_returns_none() {
...
#[test]
fn int_test_git_status_porcelain_clean_repo_is_empty() {
    if !have_git() {
...
#[test]
fn int_test_push_file_allow_args_appends_correct_flags() {
