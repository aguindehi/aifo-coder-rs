...
1. Remember the current date, time and default user. Make sure to insert these informations wherever appropriate.
...
4. If the source code has been changed, score the source code and write a comprehensive scoring, inclusive grades and grade summary, to the file SCORE.md.
5. Consider the next steps according to the notes in SCORE.md.
6. Propose next steps to the user.
7. Ask the user if you should proceed with these steps.
